...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'sprite_move.data';
      var REMOTE_PACKAGE_BASE = 'sprite_move.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_sprite_move.data');

      };
      Module['addRunDependency']('datafile_sprite_move.data');
...
var wasmBinaryFile = 'sprite_move.wasm';
